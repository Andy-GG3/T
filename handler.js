...
const buka = require('./lib/andy/_autobukagrup.js')
const tutup = require('./lib/andy/_autotutupgrup.js')
const datashalat = require('./lib/andy/datashalat.js')
const scbackup = require('./schedule/backupsc.js')
const backup = require('./lib/andy/autobackup.js')
const cleartmp = require('./lib/andy/cleartmp.js')
