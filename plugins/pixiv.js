...
let atr = am.result
  var ikyy = await fetch(`https://api.lolhuman.xyz/api/pixiv?apikey=${atr}&query=${text}`)
  ...
  conn.sendFile(m.chat, res.result[banyak].image, res.result[0].title, "Hayo Nyari Apa Om" , m)
  } catch (e) {
